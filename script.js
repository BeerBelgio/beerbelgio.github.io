(() => {
  ...
  function applyHubLanguage(lang, { historyMode = "none", persist = true } = {}) {
    ...
    const locationComma = document.querySelector(".location-comma");
    const showCountry = Boolean(copy.country);
    if (locationCountry) locationCountry.hidden = !showCountry;
    if (locationComma) locationComma.hidden = !showCountry;
